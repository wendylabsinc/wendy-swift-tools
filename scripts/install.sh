...
WENDY_SDK_URL="https://github.com/wendylabsinc/wendy-swift-tools/releases/download/v0.1-pre-release/6.1-RELEASE_edgeos_aarch64.artifactbundle.tar.gz"

SWIFT_PKG_FILE="$(basename $SWIFT_PKG_URL)"
WENDY_SDK_FILE="$(basename $WENDY_SDK_URL)"
WENDY_SDK_NAME="6.1-RELEASE_edgeos_aarch64"
